...
New_BasicMesh::~New_BasicMesh()
{
    Clear();
}

void New_BasicMesh::Clear()
{
    if (m_Buffers[0] != 0)
    {
...
bool New_BasicMesh::LoadMesh(const string& Filename, int AssimpFlags)
{
...
bool New_BasicMesh::InitFromScene(const aiScene* pScene, const string& Filename)
{
...
void New_BasicMesh::CountVerticesAndIndices(const aiScene* pScene, uint& NumVertices, uint& NumIndices)
{
...
void New_BasicMesh::ReserveSpace(unsigned int NumVertices, unsigned int NumIndices)
{
...
void New_BasicMesh::InitAllMeshes(const aiScene* pScene)
{
    for (unsigned int i = 0; i < m_Meshes.size(); i++) {
...
void New_BasicMesh::InitSingleMesh(uint MeshIndex, const aiMesh* paiMesh)
{
...
void New_BasicMesh::InitSingleMeshOpt(uint MeshIndex, const aiMesh* paiMesh)
{
    const aiVector3D Zero3D(0.0f, 0.0f, 0.0f);
...
void New_BasicMesh::OptimizeMesh(int MeshIndex, std::vector<uint>& Indices, std::vector<Vertex>& Vertices)
{
...
bool New_BasicMesh::InitMaterials(const aiScene* pScene, const string& Filename)
{
...
void New_BasicMesh::LoadTextures(const string& Dir, const aiMaterial* pMaterial, int Index)
{
...
void New_BasicMesh::LoadDiffuseTexture(const string& Dir, const aiMaterial* pMaterial, int MaterialIndex)
{
...
void New_BasicMesh::LoadDiffuseTextureEmbedded(const aiTexture* paiTexture, int MaterialIndex)
{
...
void New_BasicMesh::LoadDiffuseTextureFromFile(const string& Dir, const aiString& Path, int MaterialIndex)
{
...
void New_BasicMesh::LoadSpecularTexture(const string& Dir, const aiMaterial* pMaterial, int MaterialIndex)
{
...
void New_BasicMesh::LoadSpecularTextureEmbedded(const aiTexture* paiTexture, int MaterialIndex)
{
...
void New_BasicMesh::LoadSpecularTextureFromFile(const string& Dir, const aiString& Path, int MaterialIndex)
{
    string FullPath = GetFullPath(Dir, Path);
...
void New_BasicMesh::LoadAlbedoTexture(const string& Dir, const aiMaterial* pMaterial, int MaterialIndex)
{
...
void New_BasicMesh::LoadAlbedoTextureEmbedded(const aiTexture* paiTexture, int MaterialIndex)
{
...
void New_BasicMesh::LoadAlbedoTextureFromFile(const string& Dir, const aiString& Path, int MaterialIndex)
{
    string FullPath = GetFullPath(Dir, Path);
...
void New_BasicMesh::LoadMetalnessTexture(const string& Dir, const aiMaterial* pMaterial, int MaterialIndex)
{
...
void New_BasicMesh::LoadMetalnessTextureEmbedded(const aiTexture* paiTexture, int MaterialIndex)
{
...
void New_BasicMesh::LoadMetalnessTextureFromFile(const string& Dir, const aiString& Path, int MaterialIndex)
{
    string FullPath = GetFullPath(Dir, Path);
...
void New_BasicMesh::LoadRoughnessTexture(const string& Dir, const aiMaterial* pMaterial, int MaterialIndex)
{
...
void New_BasicMesh::LoadRoughnessTextureEmbedded(const aiTexture* paiTexture, int MaterialIndex)
{
...
void New_BasicMesh::LoadRoughnessTextureFromFile(const string& Dir, const aiString& Path, int MaterialIndex)
{
    string FullPath = GetFullPath(Dir, Path);
...
void New_BasicMesh::LoadColors(const aiMaterial* pMaterial, int index)
{
...
void New_BasicMesh::PopulateBuffers()
{
    if (IsGLVersionHigher(4, 5)) {
        PopulateBuffersDSA();
    }
...
void New_BasicMesh::PopulateBuffersNonDSA()
{
...
void New_BasicMesh::PopulateBuffersDSA()
{
...
void New_BasicMesh::Render(IRenderCallbacks* pRenderCallbacks)
{
    if (m_isPBR) {
...
void New_BasicMesh::SetupRenderMaterialsPhong(unsigned int MeshIndex, unsigned int MaterialIndex, IRenderCallbacks* pRenderCallbacks)
{
...
void New_BasicMesh::SetupRenderMaterialsPBR()
{
...
void New_BasicMesh::Render(unsigned int DrawIndex, unsigned int PrimID)
{
    glBindVertexArray(m_VAO);
...
void New_BasicMesh::Render(unsigned int NumInstances, const Matrix4f* WVPMats, const Matrix4f* WorldMats)
{
...
const Material& New_BasicMesh::GetMaterial()
{
...
void New_BasicMesh::GetLeadingVertex(uint DrawIndex, uint PrimID, Vector3f& Vertex)
{
