...
void Shader::LoadOLD(std::string vertexPath, std::string fragmentPath) {

    //std::cout << "Loading: " << vertexPath << " " << fragmentPath << "\n";

    std::string vertexSource = Util::ReadTextFromFile("res/shaders/OpenGL_OLD/" + vertexPath);
    std::string fragmentSource = Util::ReadTextFromFile("res/shaders/OpenGL_OLD/" + fragmentPath);
...
{
    std::string vertexSource = Util::ReadTextFromFile("Resources/Shaders/OpenGL_OLD/" + vertexPath);
    std::string fragmentSource = Util::ReadTextFromFile("Resources/Shaders/OpenGL_OLD/" + fragmentPath);
    std::string geometrySource = Util::ReadTextFromFile("Resources/Shaders/OpenGL_OLD/" + geomPath);
...
void ComputeShader::LoadOLD(std::string computePath) {
