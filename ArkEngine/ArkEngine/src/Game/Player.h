...
struct PlayerControls {
    ...
    unsigned int CROUCH = ARK_KEY_WIN_CONTROL; // different mapping to the standard glfw ARK_KEY_LEFT_CONTROL
...
private:
    ...
    glm::vec3 _rotation = glm::vec3(-0.1f, -ARK_PI * 0.5f, 0);
