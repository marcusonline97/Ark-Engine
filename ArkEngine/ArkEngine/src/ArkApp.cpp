...
void App::Run()
{
    ...
    {
        // For now, the rendered cube is driven by the editor's first object ("Cube").
        // This is the bridge between the Inspector and the actual scene render until ECS/Scene is wired in.
