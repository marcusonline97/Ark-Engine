...
#define ARK_PRECISE_PI 3.14159265358979323846
#define ARK_PI 3.14159265f
#define ARK_EPSILON 1e-12f
#define ARK_SQRT_OF_TWO static_cast<float>(sqrt(2.0))
#define ARK_SQRT_OF_HALF 1.0f / ARK_SQRT_OF_TWO
...
// Cursors
#define ARK_CURSOR_ARROW           0x00036001
#define ARK_CURSOR_IBEAM           0x00036002
#define ARK_CURSOR_CROSSHAIR       0x00036003
#define ARK_CURSOR_HAND            0x00036004
#define ARK_CURSOR_HRESIZE         0x00036005
#define ARK_CURSOR_VRESIZE         0x00036006
