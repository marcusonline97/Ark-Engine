...
struct PlayerControls {
    unsigned int WALK_FORWARD = ARK_KEY_W;
    unsigned int WALK_BACKWARD = ARK_KEY_S;
    unsigned int WALK_LEFT = ARK_KEY_A;
    unsigned int WALK_RIGHT = ARK_KEY_D;
    unsigned int INTERACT = ARK_KEY_E;
    unsigned int RELOAD = ARK_KEY_R;
    unsigned int FIRE = ARK_MOUSE_LEFT;
    unsigned int ADS = ARK_MOUSE_RIGHT;
    unsigned int JUMP = ARK_KEY_SPACE;
    unsigned int CROUCH = ARK_KEY_WIN_CONTROL; // different mapping to the standard glfw HELL_KEY_LEFT_CONTROL
    unsigned int NEXT_WEAPON = ARK_KEY_Q;
    unsigned int ESCAPE = ARK_KEY_WIN_ESCAPE;
    unsigned int DEBUG_FULLSCREEN = ARK_KEY_G;
    unsigned int DEBUG_ONE = ARK_KEY_1;
    unsigned int DEBUG_TWO = ARK_KEY_2;
    unsigned int DEBUG_THREE = ARK_KEY_3;
    unsigned int DEBUG_FOUR = ARK_KEY_4;
    unsigned int MELEE = ARK_KEY_V;
    unsigned int FLASHLIGHT = ARK_KEY_F;
    unsigned int MISC_WEAPON_FUNCTION = ARK_KEY_T;
    unsigned int RUN = ARK_KEY_LEFT_SHIFT;
    unsigned int TOGGLE_INVENTORY = ARK_KEY_WIN_TAB;
};
